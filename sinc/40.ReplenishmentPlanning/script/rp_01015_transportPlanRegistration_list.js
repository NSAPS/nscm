...
function setEditMode( objTd ) {
	...
	if(document.frm.trans_date[rowIdx]){
		...
		transDate	= document.frm.trans_date.value;
...
function addRow( objBtn ) {
	...
	var oCell4  = oRowLeft.insertCell(); // 제품코드
	var oCell5  = oRowLeft.insertCell(); // 제품명
	
	var oCell6 = oRowMain.insertCell(); // 기본재고상차 PLT
	var oCell7 = oRowMain.insertCell(); // 기본재고상차 BOX 
	var oCell8 = oRowMain.insertCell(); // 기본재고상차 BOX

	
	oCell2.onclick = function() { setEditMode(this); }; // 수송일자
	oCell3.onclick = function() { setEditMode(this); }; // 수송일자
	oCell4.onclick  = function() { setEditMode(this); }; // 차량순번
	
	oCell6.onclick  = function() { setEditMode(this); }; // 기본재고상차 PLT
	oCell7.onclick  = function() { setEditMode(this); }; // 기본재고상차 BOX

	
	oCell0.align = "center"; 	oCell0.width = "30px" ; // 번호
	oCell2.align = "center"; 	oCell2.width = "95px" ; // 수송일자
	oCell3.align = "center"; 	oCell3.width = "80px"; // 차량순번
	oCell4.align = "center"; 	oCell4.width = "110px"; // 제품코드
	oCell5.align = "left";   	oCell5.width = "150px"; // 제품명
	

	oCell6.align = "right";  oCell6.width = "80px" ; // 기본재고상차 PLT
	oCell7.align = "right";  oCell7.width = "80px" ; // 기본재고상차 BOX
	oCell8.align = "right";  oCell8.width = "110px" ; // 전표번호
	...
	// 제품코드
	oCell4.innerHTML = "<a id=\"divItemId\"></a><a id=\"divItemInput\" style=\"display:none; \"><input type=\"text\" "
	...
	// 제품명
	oCell5.innerHTML = "<a id=\"divItemName\"></a><input type=\"hidden\" name=\"item_name\">";
	// 기본재고상차 PLT
	oCell6.innerHTML = "<a id=\"divBasePlt\"></a><input type=\"text\" name=\"base_stk_plt\" class=\"normal\" size=\"20\" "
						+ "onKeyDown=\"moveNextBox(this); \" onFocusOut=\"setViewMode(this); \" "
						+ "style=\"width:100%; padding-right:5px; display:none; text-align:right; \">";
	// 기본재고상차 BOX
	oCell7.innerHTML = "<a id=\"divBaseBox\"></a><input type=\"text\" name=\"base_stk_box\" class=\"normal\" size=\"20\" "
						+ "onKeyDown=\"moveNextBox(this); \" onFocusOut=\"setViewMode(this); \" "
						+ "style=\"width:100%; padding-right:5px; display:none; text-align:right; \">";
	// 전표번호
	oCell8.innerHTML = "<a id=\"divBrandNo\"></a><input type=\"hidden\" name=\"brand_no\">";
...
function memLastRow() {
	...
	if( document.frm.routeClass[tableLen-1] ) {
		...
		arrData[5] 	= document.frm.brand_no[tableLen-1].value; // 기본재고상차 BOX
	}
	else {
		...
		arrData[5] 	= document.frm.brand_no.value; // 기본재고상차 BOX
	}
...
function setLastRow() {
	...
	if( document.frm.routeClass[tableLen-1] ) {
		...
		document.frm.brand_no[tableLen-1].value		= arrData[5]; // 전표번호
		...
		divBrandNo[tableLen-1].innerHTML 	= arrData[5] + "&nbsp;";  				 // 전표번호
		...
		document.frm.brand_no.value = arrData[5];  // 전표번호
		...
		divBrandNo.innerHTML 	= arrData[5] + "&nbsp;";  				 // 전표번호
	}
...
//	}
	...
	var in_paramKey = "version!%!src_loc!%!tgt_loc";
	var in_paramCode = version+"!%!"+src_loc+"!%!"+tgt_loc;
