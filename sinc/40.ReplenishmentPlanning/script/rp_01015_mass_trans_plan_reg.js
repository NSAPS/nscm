...
function addRow( objBtn ) {
	...
	var oCell2 = oRowLeft.insertCell(); // 수송일자
	var oCell3 = oRowLeft.insertCell(); // 출고장
	var oCell4 = oRowLeft.insertCell(); // 입고장
	
	var oCell5 = oRowMain.insertCell(); // 제품코드
	var oCell6 = oRowMain.insertCell(); // 제품명
	var oCell7 = oRowMain.insertCell(); // PLT_단위
	var oCell8 = oRowMain.insertCell(); // 수량 

	oCell2.onclick = function() { setEditMode(this); }; // 수송일자
	oCell3.onclick = function() { setEditMode(this); }; // 출고장
	oCell4.onclick = function() { setEditMode(this); }; // 입고장
	
	oCell5.onclick = function() { setEditMode(this); }; // 제품코드
	
	oCell7.onclick  = function() { setEditMode(this); }; // 기본재고상차 PLT
	oCell8.onclick  = function() { setEditMode(this); }; // 기본재고상차 BOX

	
	oCell0.align = "center"; 	oCell0.width = "30px" ; // 번호
	oCell1.align = "center"; 	oCell1.width = "40px" ; // 추가삭제
	oCell2.align = "center"; 	oCell2.width = "100px"; // 수송일자
	oCell3.align = "center"; 	oCell3.width = "90px"; // 출고장
	oCell4.align = "center";   	oCell4.width = "90px"; // 입고장

	oCell5.align = "center"; 	oCell5.width = "110px"; // 제품코드
	oCell6.align = "left";   	oCell6.width = "180px"; // 제품명
	oCell7.align = "right";  	oCell7.width = "80px" ; // PLT_단위
	oCell8.align = "right";  	oCell8.width = "80px" ; //  수량
