//## ÇÁ·Î±×·¥ID      : ip_07090_EDI_eCvan_Analysis_pop_ecv.js
//## ÇÁ·Î±×·¥¸í      : edi ecvan ÆË¾÷
//## º¯°æÀÚÀÚ        : ÀÌ°­¿í
//## °³¹ßÀÏÀÚ        : 2015-07-20
//##
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("CNFM_DATE"		,"ÀÏÀÚ"			,"t_text"	,100	,0  ,false); //0   	
 	...
 	GridObj.AddHeader("CUST_CODE"		,"°Å·¡Ã³ÄÚµå"		,"t_text" 	,100	,70  ,false); //0   
 	GridObj.AddHeader("CUST_NAME"		,"°Å·¡Ã³¸í"		,"t_text" 	,100	,170  ,false); //0
 	GridObj.AddHeader("EDI_BOX"			,"¹ßÁÖ·®"			,"t_number" ,100.3	,50  ,false); //0
 	GridObj.AddHeader("DEFAULT_BOX"		,"¹Ì³³·®"			,"t_number" ,100.3	,50  ,false); //0
 	GridObj.AddHeader("AMOUNT"			,"´Ü°¡"			,"t_number" ,100.3	,50  ,false); //0
 	GridObj.AddHeader("DEFAULT_AMOUNT"	,"¹Ì³³\n±Ý¾×"		,"t_number" ,100.3	,50  ,false); //0
	GridObj.AddHeader("DEFAULT_CODE"	,"»çÀ¯ÄÚµå"		,"t_text" 	,100	,0  ,false); 
 	GridObj.AddHeader("CODE_NAME"		,"»çÀ¯¸í"     	,"t_combo" 	,100	,150  ,true); //0 
 	GridObj.AddHeader("DC_ID"			,"¹è¼ÛÁöÁ¡ÄÚµå"	,"t_text" 	,100	,0  ,false); //0
 	GridObj.AddHeader("DC_NAME"			,"¹è¼ÛÁöÁ¡"		,"t_text" 	,100	,60  ,false); //0 
 	GridObj.AddHeader("DEPT_CODE"		,"¿µ¾÷ÁöÁ¡ÄÚµå"	,"t_text" 	,100	,0  ,false); //0   
 	GridObj.AddHeader("DEPT_NAME"		,"¿µ¾÷ÁöÁ¡"		,"t_text" 	,100	,75  ,false); //0   
 	GridObj.AddHeader("HAN_NAME"		,"´ã´çÀÚ"			,"t_text" 	,100	,50  ,false); //0   
 	GridObj.AddHeader("TEL_NO"			,"¿¬¶ôÃ³"			,"t_text" 	,100	,60  ,false); //0   
 	GridObj.AddHeader("BIGO"			,"ºñ°í"			,"t_text" 	,100	,50 ,false); //0 	
...
function GridSetMerge(){		
        ...
        GridObj.AddSummaryBar('SUMMARY1', 'ÇÕ°è', 'summaryall', 'sum', 'EDI_BOX,DEFAULT_BOX'); 
