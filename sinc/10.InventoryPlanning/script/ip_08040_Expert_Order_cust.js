//## ÇÁ·Î±×·¥ID		: ip_08040_Expert_Order_cust.js
//## ÇÁ·Î±×·¥¸í		: °Å·¡¼±º° ÁÖ¹® °ü¸®
//## º¯°æÀÚ			: ÀÌ°­¿í
//## °³¹ßÀÏÀÚ			: 2016-05-03
//##
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("CNFM_DATE"	   	,"ÁÖ¹®Á¢¼öÀÏ"  	,"t_text"     	,100		,70     ,false); //0 
	GridObj.AddHeader("CUST_CODE"		,"°Å·¡¼± ÄÚµå"		,"t_text" 	    ,100	    ,0     	,false); //0  
	GridObj.AddHeader("CUST_NAME"		,"°Å·¡¼±¸í"  		,"t_text"     	,100		,220    ,false); //0  
 	
 	GridObj.AddHeader("ORDER_QTY"		,"ÁÖ¹®·®"			,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("PLAN_QTY"		,"ÁÖ°£\n»ý»ê°èÈ¹·®"	,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("PROD_QTY"		,"»ý»ê·®"			,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("EXPT_QTY"		,"»ý»ê¿¹Á¤·®"		,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("TOTAL_QTY"		,"ÃÑ °ø±Þ·®"		,"t_number"  	,100.3		,80    ,false); //0
 	
 	GridObj.AddHeader("WH_STOCK"		,"ÀÛ¾÷ÀåÀç°í"	    ,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("CY_STOCK"		,"ºÎµÎÀç°í"	    ,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("BILL_QTY"		,"¸¶°¨¼ö·®"	    ,"t_number"  	,100.3		,80    ,false); //0
 	GridObj.AddHeader("ERNAM"			,"´ã´çÀÚ"  		,"t_text"     	,100		,70    ,false); //0 
...
function GridSetMerge(){	
    ...
    GridObj.AddSummaryBar('SUMMARY1', 'ÀÏÀÚº° °è', 'CNFM_DATE', 'sum', 'ORDER_QTY,PLAN_QTY,PROD_QTY,EXPT_QTY,TOTAL_QTY,WH_STOCK,CY_STOCK,BILL_QTY');
    GridObj.AddSummaryBar('SUMMARY2', 'ÀüÃ¼ °è'	, 'summaryall', 'sum', 'ORDER_QTY,PLAN_QTY,PROD_QTY,EXPT_QTY,TOTAL_QTY,WH_STOCK,CY_STOCK,BILL_QTY');
