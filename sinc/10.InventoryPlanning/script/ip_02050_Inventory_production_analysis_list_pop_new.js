//## 프로그램ID		:	ip_02050_Inventory_production_analysis_list_pop_new.js
...
var job_id = 'ip_02050_Inventory_production_analysis_list_pop_new';
...
function setHeader(GridObj) {        
	...
	commonUtil.getSelQeury( "item_id", item_id, "ip_02050_Inventory_production_analysis_list_pop_up_header",{
		callback:function(result){

		  	GridObj.AddHeader("GUBN"	,"구분"      	,"t_text" 	,100.3		,70  ,false); //0   
...
function GridEndQuery() 
{
	...
	GridObj.SetCellBgColor('GUBN',   4, color_edit_col);
	GridObj.SetCellBgColor('DAY_00', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_01', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_02', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_03', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_04', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_05', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_06', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_07', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_08', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_09', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_10', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_11', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_12', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_13', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_14', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_15', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_16', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_17', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_18', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_19', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_20', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_21', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_22', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_23', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_24', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_25', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_26', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_27', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_28', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_29', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_30', 4, color_edit_col);

	GridObj.SetCellBgColor('DAY_31', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_32', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_33', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_34', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_35', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_36', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_37', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_38', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_39', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_40', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_41', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_42', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_43', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_44', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_45', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_46', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_47', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_48', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_49', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_50', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_51', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_52', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_53', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_54', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_55', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_56', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_57', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_58', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_59', 4, color_edit_col);
	GridObj.SetCellBgColor('DAY_60', 4, color_edit_col);
...
function CellClick_DW1(strColumnKey, nRow) {
	Grid_idx = 1;
...
// 6 재고일수 -> 1 가용일수(2)
		...
		base_stock	= Number(GridObj.GetCellValue(start_hd_name, 5)); // 원래 0
		chgo_qty	= Number(GridObj.GetCellValue(start_hd_name, 2)); // 원래 2
		ipgo_qty	= Number(GridObj.GetCellValue(start_hd_name, 4)); // 원래 3
		gy_ipgo_qty	= Number(GridObj.GetCellValue(start_hd_name, 3)); // 원래 4
		...
		//가용재고 전개..
		gy_base_stock = Number(GridObj.GetCellValue(start_hd_name, 5)); // 원래 0
	...
	for (i=0; i < 61 ; i++) {
		...
		GridObj.SetCellValue(hd_name, 6,  stock_dqy); // 원래 1
		...
		GridObj.SetCellValue(hd_name, 5,  next_stock);					// 원래 0
		GridObj.SetCellValue(hd_name, 0,  gy_next_stock); //가용재고량	// 원래 5

		base_stock	= Number(GridObj.GetCellValue(hd_name, 5));	// 원래 0
		chgo_qty	= Number(GridObj.GetCellValue(hd_name, 2));	// 원래 2
		ipgo_qty	= Number(GridObj.GetCellValue(hd_name, 4));	// 원래 3
		
		gy_base_stock	= Number(GridObj.GetCellValue(hd_name, 0)); // 원래 5
		gy_ipgo_qty		= Number(GridObj.GetCellValue(hd_name, 3)); // 원래 4
		
		if(gy_base_stock < chgo_qty){ // 기초재고가 해당일 출고량보다 많으면..  
			chgo_qty = gy_base_stock; // 기초재고만큼만 출고가능..
			GridObj.SetCellValue(hd_name, 2,  chgo_qty); // 원래 2
		}else{
			//alert("next_stock 이 0 이하!!");
			//next_stock = 0
		}
...
function sel_data_sum(obj){
	...
	if(Grid_idx == 3)		var sel_data = GridObj3.GetSelectedCells();
	else if(Grid_idx == 2)	var sel_data = GridObj2.GetSelectedCells(); 
	else					var sel_data = GridObj.GetSelectedCells();
	var i=0;
	var rowNo=0;
	...
	while(1) {
		if (sel_data.split(",")[i*2+1] == null || sel_data.split(",")[i*2+1] == "")  // 
			return;
			    ...
			    if(Grid_idx == 3)	    var value   = Number(GridObj3.GetCellValue(hd_name, rowNo));
			    else if(Grid_idx == 2)	var value   = Number(GridObj2.GetCellValue(hd_name, rowNo));
			    else	   		 		var value   = Number(GridObj.GetCellValue(hd_name, rowNo));
