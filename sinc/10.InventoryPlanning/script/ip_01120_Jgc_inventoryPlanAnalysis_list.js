...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("DIVISION"	       ,"±¸ºÐ"	    	,"t_text"      ,100	    ,0     ,false); //0	
 	...
 	GridObj.AddHeader("USE_PLAN"	       ,"´ç¿ù\nÃ³¸®°èÈ¹"		,"t_number"    ,100.3	,70     ,false); //0
 	...
 	GridObj.AddHeader("MONTH_RATE"	       ,"´ç¿ù¼ÒÁøÀ²"       	,"t_text"      ,100		,70     ,false); //0
    ...
    GridObj.AddHeader("REMAIN_PRICE"	   ,"Àå±âÃ¼È­\nÀÜ¿©±Ý¾×"	,"t_number"    ,100.3	,100     ,false); //0
...
function GridSetMerge(){
		...
		GridObj.SetGroupMerge('SALES_CAT03,ITEM_ID,ITEM_NAME,SPEC');
      	GridObj.AddSummaryBar('SUMMARY1', '¼Ò°è', 'SALES_CAT03', 'sum', 'JGC_STOCK,USE_PLAN,STOCK_DAY,PROD_TERM,TERM_VAL,SALES_PRE,SALES_CUR,SALES_CUM,MONTH_RATE,SALES_SUM,REMAIN_STOCK,REMAIN_PRICE,' +
  	 	...
  	 	GridObj.AddSummaryBar('SUMMARY2', 'ÇÕ°è', 'summaryall', 'sum', 'JGC_STOCK,USE_PLAN,STOCK_DAY,PROD_TERM,TERM_VAL,SALES_PRE,SALES_CUR,SALES_CUM,MONTH_RATE,SALES_SUM,REMAIN_STOCK,REMAIN_PRICE,' +
		'REMAIN_DAY,EXPIRY_VERSION,DUE_DATE,STOCK_USE_PER,REGISTER_AGO,EXPECT_QTY,EXPECT_QTY2,EXPECT_QTY3,EXPECT_QTY4,SALES_MEAN_3WEEK,REGISTER_DAY'); 
		...
		var rowcount = GridObj.GetMergeCount('SALES_CAT03');   //¼Ò°è ÀÎµ¦½º ±¸ÇÏ±â
         	    for (var i=0; i<rowcount; i++){
         	    	...
         	    	/* »ç¿ëÀÚ ÁöÁ¤ °è»ê½Ä Ãß°¡ - Àç°í¼ÒÁøÀ²,´ç¿ù¼ÒÁøÀ² */
