//## ÇÁ·Î±×·¥ID      : ip_01170_inventoryPlanAnalysis_md_semi_list.js
//## ÇÁ·Î±×·¥¸í      : ¼ÒºÐ À¯Åë°¡°ø ÇöÈ²
//## º¯°æÀÚÀÚ        : ÀÌ°­¿í
//## °³¹ßÀÏÀÚ        : 2015-08-06
//##
...
function setDefault() { 
    ...
    //GridObj.strHDClickAction		= "sortsingle";   	//ÀÚµ¿ sort ±â´É
...
function setHeader(GridObj) {        
    ...
    GridObj.AddHeader("STOCK_EXPT"	       ,"¿¹»óÀç°í"		,"t_number"    ,100.3	,70     ,false); //0
 	GridObj.AddHeader("OUT_STOCK"	       ,"»ç¿ÜÀç°í"	    ,"t_number"    ,100.3	,0     ,false); //0
 	GridObj.AddHeader("SALES_MEAN_1MON"    ,"1°³¿ù\nÁÖÆò±Õ"	,"t_number"    ,100.3	,0     ,false); //0
	GridObj.AddHeader("SALES_MEAN_1MON2"   ,"1°³¿ù\nÁÖÆò±Õ"	,"t_number"    ,100.3	,0     ,false); //0
	GridObj.AddHeader("SALES_MEAN_3MON2"   ,"3°³¿ù\nÁÖÆò±Õ"	,"t_number"    ,100.3	,0     ,false); //0
    GridObj.AddHeader("SALES_MEAN_3MON"    ,"3°³¿ù\nÁÖÆò±Õ"	,"t_number"    ,100.3   ,0     ,false) //0
    ...
    GridObj.AddHeader("PRE_MONTH_SELL"	   ,"Àü¿ù°è"	    	,"t_number"    ,100.3	,60     ,false); //0
 	...
 	GridObj.AddHeader("RECEIPT_EXPT_SUM"   ,"´ç¿ù»ý»ê\n´©°è"	,"t_number"    ,100.3	,70     ,false); //0 	
 	GridObj.AddHeader("RECEIPT_EXPT_PRE"   ,"Àü¿ù»ý»ê\n´©°è"	,"t_number"    ,100.3	,70     ,false); //0 
 	GridObj.AddHeader("RECEIPT_YEAR_SUM"   ,"±Ý³â»ý»ê\n´©°è"	,"t_number"    ,100.3	,80     ,false); //0
 	GridObj.AddHeader("RECEIPT_YEAR_SUM_PRE"   ,"Àü³â»ý»ê\n´©°è"	,"t_number"    ,100.3	,80     ,false); //0
 	...
 	GridObj.AddHeader("NWGT_PER_BUOM"  	   			,"±âÃÊÀç°í\nÁß·®(t)"		,"t_number"     ,100.3	,0     ,false); //0
 	GridObj.AddHeader("RECEIPT_EXPT_SUM_BUOM"   	,"´ç¿ù»ý»ê\n´©°èÁß·®(t)"	,"t_number"     ,100.3	,0     ,false); //0
 	GridObj.AddHeader("RECEIPT_YEAR_SUM_BUOM"   	,"±Ý³â»ý»ê\n´©°èÁß·®(t)"	,"t_number"     ,100.3	,0     ,false); //0
 	GridObj.AddHeader("RECEIPT_YEAR_SUM_PRE_BUOM" 	,"Àü³â»ý»ê\n´©°èÁß·®(t)"	,"t_number"     ,100.3	,0     ,false); //0 
 	
 	GridObj.AddHeader("MON_SALE_CUM_BUOM"  	   	,"´ç¿ùÆÇ¸Å\n´©°èÁß·®(t)"		,"t_number" ,100.3	,0     ,false); //0
 	GridObj.AddHeader("YEAR_SALE_CUM_BUOM" 		,"±Ý³âÆÇ¸Å\n´©°èÁß·®(t)"		,"t_number" ,100.3	,0     ,false); //0
 	GridObj.AddHeader("YEAR_SALE_PRE_CUM_BUOM" 	,"Àü³âÆÇ¸Å\n´©°èÁß·®(t)"		,"t_number" ,100.3	,0     ,false); //0
 	
 	GridObj.AddHeader("BOX_PER_WORK_COST" 	,"¹Ú½º´ç\nÀÛ¾÷ºñ"			,"t_number" ,100.3	,70     ,false); //0
 	GridObj.AddHeader("ISSUE_BOX_CUM" 		,"±Ý³â ÃÑ\nÀÛ¾÷ºñ"				,"t_number" ,100.3	,70     ,false); //0
 	GridObj.AddHeader("ISSUE_CUM" 			,"±Ý³â¸ÅÃâ¾×´©°è"			,"t_number" ,100.3	,90     ,false); //0
 	GridObj.AddHeader("DEV_WORK_COST" 		,"¸ÅÃâ¾×´ëºñ\nÀÛ¾÷ºñºñÀ²"	,"t_text" 	,100	,70     ,false); //0
...
function GridSetMerge(){	
		...
		GridObj.SetGroupMerge('SALES_CAT03');
      	...
      	GridObj.AddSummaryBar('SUMMARY2', '¼Ò°è', 'SALES_CAT03', 'sum', 'BASE_STOCK,PROD_TERM,STOCK_DAY,SALES_PRE,SALES_CUR,SALES_SUM,STOCK_EXPT,' +
 	  	...
 	  	GridObj.AddSummaryBar('SUMMARY3', 'ÇÕ°è', 'summaryall', 'sum', 'BASE_STOCK,PROD_TERM,STOCK_DAY,SALES_PRE,SALES_CUR,SALES_SUM,STOCK_EXPT,' +
      			'OUT_STOCK,SALES_MEAN_1MON,SALES_MEAN_3MON,SALES_MEAN_1WEEK,SALES_MEAN_3WEEK,PRE_MONTH_SELL,SALES_SUM_PY,SUB_PY_MON,THIS_YEAR_SUM,' +
      			'LAST_YEAR_SUM,SUB_PY_YEAR,RECEIPT_EXPT_SUM,RECEIPT_EXPT_PRE,RECEIPT_YEAR_SUM,RECEIPT_YEAR_SUM_PRE,STOCK_HIDDEN,TERM_HIDDEN,TERM_VAL,NWGT_PER_BUOM,'+
      			'RECEIPT_EXPT_SUM_BUOM,RECEIPT_YEAR_SUM_BUOM,RECEIPT_YEAR_SUM_PRE_BUOM,MON_SALE_CUM_BUOM,YEAR_SALE_CUM_BUOM,YEAR_SALE_PRE_CUM_BUOM,BOX_PER_WORK_COST,ISSUE_BOX_CUM,ISSUE_CUM'); 	
