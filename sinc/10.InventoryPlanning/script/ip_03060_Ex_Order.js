...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("SALES_CAT032"	,"Ç°Á¾"			,"t_text" 	   	,100		,0      ,false); //0   
 	...
 	GridObj.AddHeader("PM_AVG"			,"¿ùÆò±Õ"	    	,"t_number"  	,100.3		,60    ,false); //0 	
 	GridObj.AddHeader("M_0"				,"M"	    	,"t_number"  	,100.3		,60    ,false); //0
 	GridObj.AddHeader("M_REMAIN"		,"M ÀÜ¿©"	    ,"t_number"  	,100.3		,60    ,true); //0
 	...
 	GridObj.AddHeader("TOTAL_NEED"		,"ÃÑÇÊ¿ä·®"	    ,"t_number"  	,100.3		,70    ,false); //0
	...
	GridObj.AddHeader("TOTAL_QTY"		,"ÃÑ Àç°í·®"		,"t_number"  	,100.3		,70   ,false); //0
	...
	GridObj.AddGroup	("SALES_ACT",	"¿ùº°ÆÇ¸Å");
 	...
 	GridObj.AddGroup	("RECEIPT",		"¼öÀÔ¿¹Á¤");
...
function GridChangeCell(strColumnKey, nRow, nOldValue, nNewValue) {  
	...
	/* ¿ùº°ÆÇ¸Å·® ¹× ¾ÈÀüÀç°í º¯°æ½Ã ÃÑÇÊ¿ä·® ¼öÁ¤ */
...
function GridSetMerge(){	
    ...
    GridObj.AddSummaryBar('SUMMARY1', 'Ç°Á¾º° °è', 'SALES_CAT03', 'sum', 'PM_4,PM_3,PM_2,PM_1,PM_AVG,M_0,M_REMAIN,M_1,M_2,M_3,M_4,SAFE_QTY,TOTAL_NEED,AVL_MONTH,'
    +'EVENT_QTY,BASE_STOCK,RECEIPT_EXPT,RECEIPT_EXPT2,RECEIPT_EXPT3,RECEIPT_EXPT4,RECEIPT_EXPT5,TOTAL_QTY,NEED_QTY,ORDER_QTY');
    
    GridObj.AddSummaryBar('SUMMARY2', 'ÀüÃ¼ °è'	, 'summaryall', 'sum', 'PM_4,PM_3,PM_2,PM_1,PM_AVG,M_0,M_REMAIN,M_1,M_2,M_3,M_4,SAFE_QTY,TOTAL_NEED,AVL_MONTH,'
    +'EVENT_QTY,BASE_STOCK,RECEIPT_EXPT,RECEIPT_EXPT2,RECEIPT_EXPT3,RECEIPT_EXPT4,RECEIPT_EXPT5,TOTAL_QTY,NEED_QTY,ORDER_QTY');
