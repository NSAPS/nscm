...
function setHeader(GridObj) {        
 	...
 	GridObj.AddHeader("GUBN"	    	   ,"¼Ó¼º"	    	,"t_text"  	   ,100		,50     ,false); //0
    ...
    GridObj.AddHeader("BUDU_QTY"	   	   ,"´©°è"				,"t_number"    ,100.3	,70     ,false); //0 	
 	GridObj.AddHeader("JGC_STOCK"	       ,"Àå±âÃ¼È­\nÀÜ¿©Àç°í"	,"t_number"    ,100.3	,70     ,false); //0
 	GridObj.AddHeader("JGC_START_DATE"	   ,"Àå±âÃ¼È­\n¹ß»ýÀÏ"	,"t_text"      ,100		,70     ,false); //0
 	GridObj.AddHeader("PROD_TERM"     	   ,"»ý»ê\n°æ°úÀÏ¼ö"		,"t_number"    ,100.3	,70     ,false); //0
 	GridObj.AddHeader("TERM_VAL_REMAIN"    ,"À¯Åë±âÇÑ\nÀÜ¿©ÀÏ"	,"t_number"    ,100.3	,70     ,false); //0
 	...
 	GridObj.AddHeader("JGC_PROD_DATE"	   ,"Àå±âÃ¼È­\n»ý»êÀÏ"	,"t_text"      ,100		,70     ,false); //0
 	GridObj.AddHeader("STOCK_DAY"  		   ,"Àç°íÀÏ¼ö"			,"t_number"    ,100.3	,0     ,false); //0	
    GridObj.AddHeader("SALES_MEAN_1WEEK"    ,"1ÁÖÆò±Õ"			,"t_number"    ,100.3	,0     ,false); //0
    GridObj.AddHeader("SALES_MEAN_3WEEK"    ,"3ÁÖÆò±Õ"			,"t_number"    ,100.3	,0     ,false); //0
...
function GridSetMerge(){
		...
		GridObj.SetGroupMerge('SALES_CAT03,ITEM_ID,ITEM_NAME,SPEC');
      	GridObj.AddSummaryBar('SUMMARY1', '¼Ò°è', 'SALES_CAT03', 'sum', 'JGC_STOCK,STOCK_DAY,PROD_TERM,SALES_PRE,SALES_CUR,' +
      			'SALES_MEAN_1WEEK,SALES_MEAN_3WEEK,JGC_OCCUR,BUDU_QTY'); 
     	 	
	   	GridObj.AddSummaryBar('SUMMARY2', 'ÇÕ°è', 'summaryall', 'sum', 'JGC_STOCK,STOCK_DAY,PROD_TERM,SALES_PRE,SALES_CUR,' +
      			'SALES_MEAN_1WEEK,SALES_MEAN_3WEEK,JGC_OCCUR,BUDU_QTY'); 
