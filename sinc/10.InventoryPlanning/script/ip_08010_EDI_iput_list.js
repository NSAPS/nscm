//## ÇÁ·Î±×·¥ID   : ip_08010_EDI_iput.js
//## ÇÁ·Î±×·¥¸í       : EDI ¸¶°¨ ÈÄ ÀÔ·Â³»¿ª Á¶È¸
//## º¯°æÀÚ             : ÀÌ°­¿í
//## °³¹ßÀÏÀÚ         : 2016-03-07
//##
...
function setDefault() { 
    ...
    GridObj.nHDLines 			= 2; 				 //Çì´õÀÇ ¶óÀÎ¼ö¸¦ ¼³Á¤ÇÑ´Ù.   
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("ROWNUM"	   		   ,"¼ø¼­"  			,"t_number"    	,100.3		,40     	,false); 
	GridObj.AddHeader("CNFM_DATE"	       ,"ÀÏÀÚ"			,"t_text"	   	,100	    ,100      	,false); 
	GridObj.AddHeader("CUST_CODE"	       ,"°Å·¡¼±ÄÚµå"		,"t_text"	   	,100	    ,0     		,false); 
 	GridObj.AddHeader("CUST_NAME"	       ,"°Å·¡¼±¸í"		,"t_text" 	   	,100	    ,200     	,false);  
 	GridObj.AddHeader("PROD_CODE"	       ,"Á¦Ç°ÄÚµå"	    ,"t_text" 	   	,100	    ,80    	 	,false); 
 	GridObj.AddHeader("PROD_NAME"	       ,"Á¦Ç°¸í"	    	,"t_text"  	   	,100		,200     	,false); 
 	GridObj.AddHeader("ODER_BOX"	       ,"¼ö·®(BOX)"	    ,"t_number"  	,100.3		,80      	,false);
 	GridObj.AddHeader("IPUT_TIME"	       ,"ÀÔ·Â½Ã°£"	    ,"t_text"    	,100		,200     	,false); 
