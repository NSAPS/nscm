...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("ROWNUM"	   		   ,"¼ø¼­"  			,"t_number"    ,100.3	,40     ,false); //0
 	...
 	GridObj.AddHeader("MI_ORDER"	       ,"¹ÌÃâ¿À´õ"	    	,"t_number"    ,100.3	,0     ,false); //0
 	GridObj.AddHeader("DONGU_STOCK"	       ,"µ¿¿ì"				,"t_number"    ,100.3	,70     ,false); //0
 	...
 	GridObj.AddHeader("SALES_CUR"	       ,"ÀÏ°è"       		,"t_number"    ,100.3	,0      ,false); //0
...
function GridSetMerge(){	
		...
		GridObj.SetGroupMerge('SALES_CAT03,ITEM_ID,ITEM_NAME,SPEC');
      	GridObj.AddSummaryBar('SUMMARY1', '¼Ò°è', 'SALES_CAT03', 'sum', 'BASE_STOCK,DONGU_STOCK,DSJ_STOCK,PS_STOCK,GITA_STOCK,SALES_CUR,SALES_SUM,STOCK_EXPT,WEEK_STOCK,CHGO_PLAN,PROD_PLAN,' +
	   	...
	   	GridObj.AddSummaryBar('SUMMARY2', 'ÇÕ°è', 'summaryall', 'sum', 'BASE_STOCK,DONGU_STOCK,DSJ_STOCK,PS_STOCK,GITA_STOCK,SALES_CUR,SALES_SUM,STOCK_EXPT,WEEK_STOCK,CHGO_PLAN,PROD_PLAN,' +
      			'AVL_STOCK,CHGO_PLAN2,PROD_PLAN2,AVL_STOCK2,CHGO_PLAN3,CY_STOCK,MI_ORDER,RECEIPT_EXPT,RECEIPT_EXPT_SUM,M_1,M_2,M_3,M_4,M_5,M_6'); 
