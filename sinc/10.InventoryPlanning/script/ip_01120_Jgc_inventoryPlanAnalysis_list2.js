//## ÇÁ·Î±×·¥ID      : ip_01120_Jgc_inventoryPlanAnalysis_list2.js
//## ÇÁ·Î±×·¥¸í      : ÆÇ¸ÅºÎÁø Àå±âÃ¼È­ ¿¹»óÇ°¸ñºÐ¼®
//## º¯°æÀÚÀÚ        : ¿ìÁ¾±Õ
...
//## 1.2		2014-05-02  ÀÌ°­¿í	   	update
//## 1.3		2014-05-14  ÀÌ°­¿í 		update
//## 1.4		2014-05-23  ÀÌ°­¿í		update
//############################################################
/************************************************************************************************************************************/
...
var job_id = 'ip_01120_Jgc_inventoryPlanAnalysis_list2';
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("DIVISION"	       ,"±¸ºÐ"	    	,"t_text"      ,100	    ,0     ,false); //0	
 	...
 	GridObj.AddHeader("SALES_CUM"	       ,"´©°è"       		,"t_number"    ,100.3	,60     ,false); //0
    GridObj.AddHeader("SALES_SUM"	       ,"ÃÑ´©°è"	    		,"t_number"    ,100.3	,60     ,false); //0
...
function GridSetMerge(){
		...
		GridObj.SetGroupMerge('SALES_CAT03,ITEM_ID,ITEM_NAME,SPEC');
      	GridObj.AddSummaryBar('SUMMARY1', '¼Ò°è', 'SALES_CAT03', 'sum', 'JGC_STOCK,STOCK_DAY,PROD_TERM,TERM_VAL,SALES_PRE,SALES_CUR,SALES_CUM,SALES_SUM,REMAIN_STOCK,' +
      			'REMAIN_DAY,EXPIRY_VERSION,DUE_DATE,STOCK_USE_PER,REGISTER_AGO,EXPECT_QTY,EXPECT_QTY2,EXPECT_QTY3,EXPECT_QTY4,SALES_MEAN_3WEEK,REGISTER_DAY'); 
	      	 	...
	      	 	GridObj.AddSummaryBar('SUMMARY2', 'ÇÕ°è', 'summaryall', 'sum', 'JGC_STOCK,STOCK_DAY,PROD_TERM,TERM_VAL,SALES_PRE,SALES_CUR,SALES_CUM,SALES_SUM,REMAIN_STOCK,' +
      			'REMAIN_DAY,EXPIRY_VERSION,DUE_DATE,STOCK_USE_PER,REGISTER_AGO,EXPECT_QTY,EXPECT_QTY2,EXPECT_QTY3,EXPECT_QTY4,SALES_MEAN_3WEEK,REGISTER_DAY'); 
...
function SummaryReport2(){
	...
	var service_url = "service.do?_moon_service=ip_01120_Jgc_inventoryPlanAnalysis_summaryReport_new2";
