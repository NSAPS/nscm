//## ÇÁ·Î±×·¥ID		: ip_03040_Pos_Singlelist.js
//## ÇÁ·Î±×·¥¸í		: Ç°¸ñº° POS DATA ºÐ¼®
//## º¯°æÀÚ			: ÀÌ°­¿í
//## °³¹ßÀÏÀÚ			: 2016-04-12
//##
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("DAY"	   			,"¿äÀÏ"  		,"t_text"     	,100		,40     ,false); //0   
	GridObj.AddHeader("EMART_EXPT"		,"±âÃÊÀç°í"		,"t_number" 	,100.3	    ,90     ,true); //0   
 	GridObj.AddHeader("EMART_POS"	    ,"POSÆÇ¸Å·®"		,"t_number" 	,100.3	    ,90     ,false); //0   
 	GridObj.AddHeader("EMART_NS"		,"³ó½É°ø±Þ·®"	    ,"t_number" 	,100.3	    ,90    	,false); //0
 	GridObj.AddHeader("HOME_EXPT"		,"±âÃÊÀç°í"		,"t_number" 	,100.3	    ,90     ,true); //0   
 	GridObj.AddHeader("HOME_POS"	    ,"POSÆÇ¸Å·®"		,"t_number" 	,100.3	    ,90     ,false); //0   
 	GridObj.AddHeader("HOME_NS"			,"³ó½É°ø±Þ·®"	    ,"t_number" 	,100.3	    ,90    	,false); //0
 	GridObj.AddHeader("LOTTE_EXPT"		,"±âÃÊÀç°í"		,"t_number" 	,100.3	    ,90     ,true); //0   
 	GridObj.AddHeader("LOTTE_POS"	    ,"POSÆÇ¸Å·®"		,"t_number" 	,100.3	    ,90     ,false); //0   
 	GridObj.AddHeader("LOTTE_NS"		,"³ó½É°ø±Þ·®"	    ,"t_number" 	,100.3	    ,90    	,false); //0
 	GridObj.AddHeader("TOT_EXPT"		,"±âÃÊÀç°í"		,"t_number" 	,100.3	    ,90     ,true); //0   
 	GridObj.AddHeader("TOT_POS"	    	,"POSÆÇ¸Å·®"		,"t_number" 	,100.3	    ,90     ,false); //0   
 	GridObj.AddHeader("TOT_NS"			,"³ó½É°ø±Þ·®"	    ,"t_number" 	,100.3	    ,90    	,false); //0
...
function doQuery() 
{
   ...
   if(confirm("ÇØ´ç Ç°¸ñÀ» Á¶È¸ ÇÏ½Ã°Ú½À´Ï±î?") == 1 ){
   	   		
	   if( start_date < "20160617") gubn = "1";			//gubn = 1  °ú°Å POS Á¶È¸ Àç°í ¹«½Ã
	   else gubn = "2";   
...
function GridSetMerge(){	
	...
	GridObj.AddSummaryBar('SUMMARY', '°è'	, 'summaryall', 'sum', 'EMART_EXPT,EMART_POS,EMART_NS,HOME_EXPT,HOME_POS,HOME_NS,LOTTE_EXPT,LOTTE_POS,LOTTE_NS,TOT_EXPT,TOT_POS,TOT_NS');  
