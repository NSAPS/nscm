//## ÇÁ·Î±×·¥ID      : ip_01130_import_md_PlanAnalysis_list.js
//## ÇÁ·Î±×·¥¸í       : ¼öÀÔ »óÇ° Àç°í °ü¸®
//## º¯°æÀÚ           : ÀÌ°­¿í
//## °³¹ßÀÏÀÚ         : 2015-03-18 
...
function setHeader(GridObj) {       
	...
	callback:function(result){
		...
		GridObj.AddHeader("SALES_CAT03"	      ,"¼ÒºÐ·ù"	    		,"t_text"      ,100	    ,70     ,false); //0
		GridObj.AddHeader("ITEM_ID"	          ,"Ç°¸ñÄÚµå"			,"t_text" 	   ,100	    ,70     ,false); //0   
	 	...
	 	GridObj.AddHeader("THREE_MON"  		  ,"3°³¿ùÆò±Õ"			,"t_text"      ,100		,0      ,false); //0		
...
//    for (var i=0; i<rowcount; i++){
//     	
//     	var AVL_STOCK = GridObj.GetCellValue('AVL_STOCK',GridObj.GetRowIndexFromMergeIndex('AVL_STOCK',i,false));		//°¢ Merge ´ÜÀÇ Ã¹ ¹øÂ° Row °ªÀ» ¹Þ¾Æ¿Â´Ù.
...
//     }
//    
//	GridObj.AddSummaryBar('SUMMARY2', 'ÇÕ°è', 'summaryall', 'custom', 'AVL_STOCK,NS_STOCK,EXP_STOCK,MONTH_5,MONTH_4,MONTH_3,MONTH_2,MONTH_1,WEEK_1,WEEK_2,WEEK_3,' +
