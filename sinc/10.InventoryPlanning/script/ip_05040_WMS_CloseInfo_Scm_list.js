//## ÇÁ·Î±×·¥ID      : ip_05040_WMS_CloseInfo_Scm_list.js
//## ÇÁ·Î±×·¥¸í      : WMS Ãâ°í¸¶°¨º° »çÀ¯°ü¸®
//## º¯°æÀÚÀÚ        : ÀÌ°­¿í
//## °³¹ßÀÏÀÚ        : 2015-02-06
//##
...
var job_id = 'ip_05040_WMS_CloseInfo_Scm_list';
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("DC_NAME"	           ,"DC¸í"			,"t_text" 	   ,100	    ,80     ,false); //0   
 	...
 	GridObj.AddHeader("GUBN"	           ,"¸¶°¨±¸ºÐ"		,"t_text" 	   ,100	    ,150    ,false); //0   
 	GridObj.AddHeader("ODER_BOX"	       ,"ÁÖ¹®"			,"t_number"    ,100.3	,80     ,false); //0   
 	GridObj.AddHeader("SELL_BOX"	       ,"¸¶°¨"			,"t_number"    ,100.3	,80     ,false); //0   
 	GridObj.AddHeader("REMN_BOX"		   ,"Â÷ÀÌ"			,"t_number"    ,100.3	,80     ,false); //0
 	GridObj.AddHeader("GUBN_SCM"	       ,"SCM ¸¶°¨±¸ºÐ"	,"t_combo"     ,100	    ,90     ,true); //0 	
 	GridObj.AddHeader("BIGO"		       ,"ºñ°í"			,"t_text" 	   ,100	    ,220    ,true); //0
  ...
  ¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥*/
   function doQuery() 
   {
       ...
       start_date 			= start_date.replace(/-/g,"");
 	   ...
 	   var insel_close_gubn 	= document.all.insel_close_gubn.value;
 	   //var insel_close_gubn_scm	= document.all.insel_close_gubn_scm.value;
 	   var in_sel_gubn			= document.all.in_sel_gubn.value;
 	   var insel_dc				= document.all.insel_dc.value;
	   ...
	   GridObj.SetParam("insel_close_gubn",     insel_close_gubn);
	  // GridObj.SetParam("insel_close_gubn_scm", insel_close_gubn_scm);
	   GridObj.SetParam("in_sel_gubn", 			in_sel_gubn);
	   GridObj.SetParam("insel_dc", 			insel_dc);
