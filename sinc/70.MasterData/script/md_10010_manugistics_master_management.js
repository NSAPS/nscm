...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("MHDHB"			,"ÃÑÀúÀå¼ö¸í"       	,"t_text" 		,100	,70   ,true); //0
 	...
 	GridObj.AddHeader("SB_FLAG"			,"Àç°í(¼ÒºÐ)"     	,"t_checkbox" 	,10		,40   ,true); //0
 	...
 	GridObj.AddHeader("SW_FLAG"			,"¼¼¿ì°øÅë"       	,"t_checkbox" 	,10		,40   ,true); //0   
