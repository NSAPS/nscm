////////////////////////////////////////////////////////////
// 프로그램ID : md_04110_transUnit_item_list.js
// 프로그램명 : 품목별 수송단위관리
// 개발자  : 권용찬
// 개발일자 : 2008-10-06 월요일
//
...
// ---------  ----------  --------  ------------------------------------
// 1.0        2008-10-06  권용찬     md_04110_transUnit_item_list.js 개발
//
//
////////////////////////////////////////////////////////////
...
function setBoxQty(objBox){
	...
	if(objBox.checked){
		...
		var box_per_palet 	= document.frm.box_per_palet[rowIdx].value;
		if(boxQty = box_per_palet){
			boxQty = 1;
		}
...
//alert("colIdx="+colIdx);	
	...
	var	search_word 	= Number(document.frm.search_word.value);//재고일수
