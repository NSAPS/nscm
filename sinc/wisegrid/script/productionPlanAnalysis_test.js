...
function headerResult(result) {		
	...
	GridObj.AddHeader("C03",	"원가부문",	"t_text",		50,		80,    	false);
	GridObj.AddHeader("C04",	"조",		"t_text",		50,		40,    	false);
	GridObj.AddHeader("C05",	"주",		"t_text",		50,		40,    	false);
	GridObj.AddHeader("C06",	"야",		"t_text",		50,		40,    	false);
	GridObj.AddHeader("C07",	"작업장",   	"t_combo",		50,		180,    true);
	
//	GridObj.AddHeader("C08",	"제품코드", 	"t_text",		50,		80,    	false);
//	GridObj.AddHeader("C09",	"제품명",	"t_text",		50,		260, 	false);
//	GridObj.AddHeader("C10",	"규격",		"t_text",		50,		90, 	false);
//	GridObj.AddHeader("C11",	"TO여",		"t_text",		50,		35, 	false);
//	GridObj.AddHeader("C12",	"구분",		"t_text",		50,		35, 	false);
	...
	GridObj.AddHeader("C11",	"TO여",		"t_combo",		50,		35, 	false);
	GridObj.AddHeader("C12",	"구분",		"t_combo",		50,		35, 	false);
	
	GridObj.AddHeader("C13",	"오더번호",	"t_text",		50,		80, 	true);
	GridObj.AddHeader("C14",	"항목번호",	"t_text",		50,		50, 	true);
	GridObj.AddHeader("C15",	"의뢰량",	"t_number",		12,		50, 	false);
	//-----------------------------------------------------------------------------//
	...
	GridObj.AddHeader("C38",	"차이",		"t_number",		50,		60, 	false);
...
function setGrid(GridObj){
	...
	// 합계
	GridObj.AddSummaryBar('SUMMARY1', '합계', 'summaryall', 'sum', 'D01A,D01B,D01C,D02A,D02B,D02C,D03A,D03B,D03C,D04A,D04B,D04C,D05A,D05B,D05C,D06A,D06B,D06C,D07A,D07B,D07C,C36,C38'); 
