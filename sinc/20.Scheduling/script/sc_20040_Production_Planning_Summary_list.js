...
function defaultHeader(result){
	...
	GridObj.AddHeader("ITEM_ID"	     		  ,"Á¦Ç°ÄÚµå"		,"t_text"	   ,80	    ,80     ,false); //0
 	GridObj.AddHeader("ITEM_NAME"	          ,"Á¦Ç°¸í"			,"t_text" 	   ,100	    ,265    ,false); //0   
 	//GridObj.AddHeader("PROC_ID"	          	  ,"ÀÛ¾÷ÀåÄÚµå"		,"t_text" 	   ,100	    ,0    ,false); //0 
 	//GridObj.AddHeader("PROC_NAME"	          ,"ÀÛ¾÷Àå¸í"		,"t_text" 	   ,100	    ,0    ,false); //0 
