...
var job_id = 'sc_13020_set_prod_mst';
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("CRUD"			,"CRUD"       	,"t_text" 	,100    ,0  ,false);
 	GridObj.AddHeader("ITYPE"			,"¿µ¾÷ÃÑ°ý"   	,"t_text" 	,20		,60  ,false); //0   
 	GridObj.AddHeader("DIVISION"		,"CM"   		,"t_text" 	,20		,60  ,false); //0   
 	GridObj.AddHeader("SALES_CAT01"		,"¿µ¾÷Ç°Á¾1"   	,"t_text" 	,20		,60  ,false); //0   
 	GridObj.AddHeader("SALES_CAT02"		,"¿µ¾÷Ç°Á¾2"   	,"t_text" 	,20		,60  ,false); //0   
 	...
 	GridObj.AddHeader("BM"				,"BM"   		,"t_text" 	,20		,60  ,true); //0   

 	GridObj.AddHeader("PROD_VER"		,"»ý»ê¹öÀü"   	,"t_text" 	,20		,40  ,false); //0   
 	GridObj.AddHeader("PROC_ID"			,"¾÷Ã¼"   		,"t_text" 	,20		,0   ,false); //0   
 	GridObj.AddHeader("PROC_NAME"		,"¾÷Ã¼"   		,"t_text" 	,20		,100 ,false); //0   
 	/////////////////////////
 	GridObj.AddHeader("LOC_ID"			,"ÀÛ¾÷Àå"   		,"t_text" 	,20		,0  ,false); //0   
 	GridObj.AddHeader("LOC_NAME"		,"ÀÛ¾÷Àå"   		,"t_text" 	,20		,100  ,false); //0   

 	GridObj.AddHeader("PROC_TYPE"		,"ÀÛ¾÷¼³ºñ"   	,"t_combo" 	,20		,90  ,true); //0
 	//    
 	GridObj.AddHeader("OPER_TYPE"		,"¿î¿µÇüÅÂ"   	,"t_combo" 	,20		,60  ,true); //0   
 	GridObj.AddHeader("OPER_QTY"		,"°èÈ¹¼ö·®"   	,"t_number" ,20.3	,60  ,true); //0   
 	GridObj.AddHeader("START_DATE"		,"½ÃÀÛÀÏÀÚ"   	,"t_text" 	,20		,80  ,true); //0   
 	GridObj.AddHeader("END_DATE"		,"Á¾·áÀÏÀÚ"   	,"t_text" 	,20		,80  ,true); //0
 	GridObj.AddHeader("SELL_STOP_DATE"	,"ÆÇ¸ÅÁ¾·áÀÏ"   	,"t_text" 	,20		,70  ,false); //0   
	
 	//GridObj.AddHeader("ROH2_COST"		,"ºÎÀÚÀç"   		,"t_number" ,20.3	,60  ,true); //0   
 	//

 	GridObj.AddHeader("COST_GUBN"		,"ºñ¿ë±¸ºÐ"   	,"t_combo" ,20	,90  ,true); //0   

 	GridObj.AddHeader("MAN_TO"			,"(³²)"  		,"t_number" ,20.3	,60  ,true); //0   
 	GridObj.AddHeader("WOMEN_TO"		,"(¿©)"  		,"t_number" ,20.3	,60  ,true); //0   
 	GridObj.AddHeader("MAN_COST"		,"(³²)" 		  	,"t_number" ,20.3	,60  ,true); //0   
 	GridObj.AddHeader("WOMEN_COST"		,"(¿©)"	   		,"t_number" ,20.3	,60  ,true); //0   

 	GridObj.AddHeader("BOX_COST"		,"BOX´ç\nÀÛ¾÷ºñ"  	,"t_number" ,20.3	,60  ,true); //0   
 	GridObj.AddHeader("WORK_CAPA"		,"ÀÏ CAPA"   	,"t_number" ,20.3	,60  ,true); //0   




	GridObj.AddGroup("HD1"	,"¿î¿µ");			//±×¸®µå¿¡ ±×·ìÀ» µî·ÏÇÑ´Ù. 
	GridObj.AppendHeader("HD1", "OPER_TYPE");
	GridObj.AppendHeader("HD1", "OPER_QTY");
	GridObj.AppendHeader("HD1", "START_DATE");
	GridObj.AppendHeader("HD1", "END_DATE");

	GridObj.AddGroup("HD2"	,"ÅõÀÔÀÎ¿ø");			//±×¸®µå¿¡ ±×·ìÀ» µî·ÏÇÑ´Ù. 
	GridObj.AppendHeader("HD2", "MAN_TO");
	GridObj.AppendHeader("HD2", "WOMEN_TO");
	
	GridObj.AddGroup("HD3"	,"ÀÎ´ç ÀÎ°Çºñ");			//±×¸®µå¿¡ ±×·ìÀ» µî·ÏÇÑ´Ù. 
	GridObj.AppendHeader("HD3", "MAN_COST");
	GridObj.AppendHeader("HD3", "WOMEN_COST");
	...
	GridObj.SetNumberFormat("MAN_TO",	"###,###,##0");
	GridObj.SetNumberFormat("WOMEN_TO", "###,###,##0");
	GridObj.SetNumberFormat("MAN_COST", "###,###,##0");
	GridObj.SetNumberFormat("WOMEN_COST", "###,###,##0");
        ...
        if(endMode == "search") //Á¶È¸°¡ ¿Ï·áµÈ °æ¿ì
        {
            ...
            {                           
				...
				for(var i=0;i<GridObj.GetRowCount();i++) {
					// cell»ö±ò º¯°æ
					GridObj.SetCellBgColor('BM', i, '255|255|0'); 
					GridObj.SetCellBgColor('PROC_TYPE', i, '255|255|0'); 
					GridObj.SetCellBgColor('OPER_TYPE', i, '255|255|0'); 
					GridObj.SetCellBgColor('OPER_QTY', i, '255|255|0'); 
					GridObj.SetCellBgColor('START_DATE', i, '255|255|0'); 
					GridObj.SetCellBgColor('END_DATE', i, '255|255|0'); 

					GridObj.SetCellBgColor('COST_GUBN', i, '255|255|0');
					
					GridObj.SetCellBgColor('MAN_TO', i, '255|255|0'); 
					GridObj.SetCellBgColor('WOMEN_TO', i, '255|255|0');
					GridObj.SetCellBgColor('MAN_COST', i, '255|255|0'); 
					GridObj.SetCellBgColor('WOMEN_COST', i, '255|255|0');
