...
function memLastRow() {
	...
	if(document.frm.itype[tableLen-1])
		arrData[3] 	= document.frm.itype[tableLen-1].value; // 운영라인
	else
		arrData[3] 	= document.frm.itype.value; // 운영라인
			
	if(document.frm.sch_plant_id[tableLen-1])
		arrData[4] 	= document.frm.sch_plant_id[tableLen-1].value; // 규격		
	else
		arrData[4] 	= document.frm.sch_plant_id.value; // 규격		
		
	if(document.frm.etc_qty1[tableLen-1])
		arrData[5] 	= document.frm.etc_qty1[tableLen-1].value; // 동시가동 불가호기
	else
		arrData[5] 	= document.frm.etc_qty1.value; // 동시가동 불가호기
...
function setLastRow() {
	...
	if(document.frm.itype[tableLen-1])
		document.frm.itype[tableLen-1].value		= arrData[3]; // 운영라인
	else	
		document.frm.itype.value		= arrData[3]; // 운영라인
		
	if(document.frm.sch_plant_id[tableLen-1])
		document.frm.sch_plant_id[tableLen-1].value 	= arrData[4]; // 규격
	else
		document.frm.sch_plant_id.value 	= arrData[4]; // 규격
		
	if(document.frm.etc_qty[tableLen-1])
		document.frm.etc_qty[tableLen-1].value = arrData[5]; // 동시가동 불가호기	
	else	
		document.frm.etc_qty.value = arrData[5]; // 동시가동 불가호기
