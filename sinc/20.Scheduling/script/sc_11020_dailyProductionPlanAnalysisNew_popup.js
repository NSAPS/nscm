...
GoSave = function() {
	...
	value += document.frm.input_start_dttm_time.value + "!%!" + document.frm.input_start_dttm_date.value;
					...
					callback:function(arrList){
						if( arrList.length > 0){	
							if(!confirm("이동할 SHIFT에 수량이 있습니다. 이동 하시겠습니까?")){
								...
								var service = "sc_11020_dailyProductionPlanAnalysisNew_popup_save02_comp";
							...
							var service = "sc_11020_dailyProductionPlanAnalysisNew_popup_save01_comp";
							frameSetService.location = "service.do?_moon_service=set_service_id&amp;user_service=" + service;				
							document.frm._moon_service.value = service;
							document.frm.action = "service.do";
							document.frm.target = "_self";
