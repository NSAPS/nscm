/**
 @path    /sinc/50.Forecast/script/fc_05090_itemSalesMonitoring_header.js
 @Creator    김규철 
 @version    1.0
 @date        2008-11-26 
 @description : 1차개발 완료
...
searchIFrameData = function(periodGB) {	  
 	...
 	if(periodGB == "D"){  
 		periodGB = "fc_05100_itemSalesMonitoring_tailer"; 		
 	}else{
 		periodGB = "fc_05090_itemSalesMonitoring_tailer"; 		
 	} 
