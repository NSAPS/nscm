//## 프로그램ID		: op_02050_roh_expt_master.js
//## 프로그램명		: 발주예시 Main화면(세우)
//## 개발자			: 이강욱
//## 개발일자			: 2016-04-20
//##
...
var job_id = 'op_02050_roh_expt_master_sw';
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("W1_STOCK"			,"차주초\n재고"     	,"t_number" 	,100.3	,60  ,false); //0 	
 	...
 	GridObj.AddHeader("SEL_DMD"				,"선택"     			,"t_combo"		,100	,80    ,false); //0	
 	GridObj.AddHeader("DMD_QTY"				,"수량"     			,"t_number"		,100.3	,60    ,false); //0
	...
	GridObj.SetNumberFormat("PR_FC_QTY", 			"#,##0");
...
//				GridObj.SetCellBgColor('FC_QTY',			i,  color_edit_col);	//발주예고량
				GridObj.SetCellBgColor('PR_FC_QTY',			i,  color_edit_col);	//발주예고량
