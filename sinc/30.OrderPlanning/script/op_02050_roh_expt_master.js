...
var job_id = 'op_02050_roh_expt_master';
...
function setHeader(GridObj) {        
	...
	GridObj.AddHeader("ITEM_ID"				,"품목번호"       	,"t_text" 		,20		,60  ,false); //0   
 	GridObj.AddHeader("ITEM_NAME"			,"품목명"      		,"t_text" 		,100	,150 ,false); //0    
