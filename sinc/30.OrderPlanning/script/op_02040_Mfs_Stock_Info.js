//## ÇÁ·Î±×·¥ID		:	op_02040_Mfs_Stock_Info.js
//## ÇÁ·Î±×·¥¸í		:	°è¿­»ç Àç°íÁ¤º¸ µî·Ï
//## °³¹ßÀÚ          :	±Ç¿ëÂù 
//## °³¹ßÀÏÀÚ       	:	2013-04-08
//##
...
function setHeader(GridObj) {        
	...
	var header_length = 0, j;
 	...
 	GridObj.AddHeader("BASE_STOCK"		,"±âÃÊÀç°í"     	,"t_number" 	,-1		,80  	,true); //0   
	GridObj.BoundHeader();	
...
function doSave() {
	...
	GridObj.SetParam("user_id",		document.frm._user_id.value);
		...
		if(com_code=="0001000050"){
			alert("ÀúÀå µ¥ÀÌÅÍ°¡ ÅÂ°æ³ó»êÀÌ ¸Â½À´Ï±î?");
		}else if(com_code=="0001000021"){
				alert("ÀúÀå µ¥ÀÌÅÍ°¡ ÃâÃÌÈ­ÇÐÀÌ ¸Â½À´Ï±î?");
		}
