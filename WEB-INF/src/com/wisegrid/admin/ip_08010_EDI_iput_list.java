 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class ip_08010_EDI_iput_list extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String paramKey   = "start_date!%!end_date!%!search_item!%!user_id";                                                                      
			String paramCode  = start_date+"!%!"+end_date+"!%!"+search_item+"!%!"+user_id;   
			
			String query_id   = "ip_08010_EDI_iput_list";                                                             
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("ROWNUM"       		).addValue(qResult.get(i).get(0), "");
				...
				gdRes.getHeader("PROD_CODE"        	).addValue(qResult.get(i).get(4), "");
				gdRes.getHeader("PROD_NAME"        	).addValue(qResult.get(i).get(5), "");
