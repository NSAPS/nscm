 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class op_02050_roh_expt_master_sw extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {                                                                                                                
			...
			String query_id		=	"op_02050_roh_expt_master_sw";                                                             
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("PR_FC_QTY"			).addValue(qResult.get(i).get(26),"");	
			}                                                                                                                
	...
	public GridData doSave(GridData gdReq) throws Exception {
		...
		String pr_fc_qty		=	gdReq.getParam("pr_fc_qty");
		...
		try {
			...
			for (int i = 0; i < rowCount; i++) {
				...
				if(crud.equals("U")) {
					...
					sql2	+=	"			'" + gdReq.getHeader("PR_FC_QTY"	).getValue(i) 			+ "'	AS PR_FC_QTY, 			\n";
			...
			sql2 += " MF.PR_FC_QTY 	 	= MF1.PR_FC_QTY,         	   	   																\n";  	/* 발주예고량  */
			
			sql2 += " MF.MADE_DTTM 	 		= SYSDATE,         	   	   																\n";  	
			sql2 += " MF.MADE_BY 	 		= MF1.MADE_BY         	   	   															\n";  	
			
			sql2 += "when not matched then insert(MF.CNFM_DATE,		MF.CONS_ITEM_ID,	MF.PR_FC_QTY,	MF.MADE_DTTM,	MF.MADE_BY)		\n";
			sql2 += "values						 (MF1.CNFM_DATE,	MF1.CONS_ITEM_ID,	MF1.PR_FC_QTY,	SYSDATE,		MF1.MADE_BY)	\n";			
			///////////////////////발주예고량 저장 SQL/////////////////////////////////////////////////////////////////////////////////////////
