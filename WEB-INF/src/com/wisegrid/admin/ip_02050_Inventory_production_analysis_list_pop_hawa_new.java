 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class ip_02050_Inventory_production_analysis_list_pop_hawa_new extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String export_flag  = gdReq.getParam("export_flag");
			                                                                                                                 
			String paramKey   ="item_id!%!item_name!%!week_flag!%!simul_data!%!export_flag";                                                                      
			String paramCode  = item_id+"!%!"+item_name+"!%!"+week_flag+"!%!"+simul_data + "!%!" + export_flag;
                                                                                                                             
			String query_id   = "ip_02050_Inventory_production_analysis_list_pop_hawa_act";                                                             
	...
	public GridData doQuery2(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_02050_Inventory_production_analysis_list_pop_hawa_DW2";                                                             
			ArrayList<ArrayList<String>> qResult = new CommonUtil().getSelQeury(paramKey, paramCode, query_id);              
			rowCount = qResult.size();                                                                                       
			//                                                                                                               
			if (rowCount == 0) {                                                                                             
	...
	public GridData doQuery3(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_02050_Inventory_production_analysis_list_pop_hawa_DW3";                                                             
