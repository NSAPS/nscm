 ...
 * @author iCOMPIA CORP.
 */
public class sc_01090_jobChangeMgmt_lst extends HttpServlet {
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {
			...
			String p_line       = gdReq.getParam("line");
			String p_proc       = gdReq.getParam("proc");

			String paramKey   ="p_plant_name!%!p_line!%!p_proc";
			String paramCode  = p_plant_name+"!%!"+p_line+"!%!"+p_proc;
			String query_id   = "sc_01090_jobChangeMgmt_list";
