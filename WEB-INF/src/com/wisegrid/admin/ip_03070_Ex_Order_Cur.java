 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class ip_03070_Ex_Order_Cur extends HttpServlet {                                                             
	...
	try {                                                                                                                
			...
			String query_id   = "ip_03070_Ex_Order_Cur";                                                             
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("LEADTIME"	    ).addValue(qResult.get(i).get(3), "");
				gdRes.getHeader("PRE_MONTH_SELL").addValue(qResult.get(i).get(4), "");			
				gdRes.getHeader("M_0"     		).addValue(qResult.get(i).get(5), "");				
				gdRes.getHeader("M_1"     		).addValue(qResult.get(i).get(6), "");
				gdRes.getHeader("M_2"     		).addValue(qResult.get(i).get(7), "");
				gdRes.getHeader("M_3"     		).addValue(qResult.get(i).get(8), "");
				gdRes.getHeader("EXPT_QTY"     	).addValue(qResult.get(i).get(9), "");
				gdRes.getHeader("SAFE_QTY"     	).addValue(qResult.get(i).get(10), "");
				gdRes.getHeader("EVENT_QTY"     ).addValue(qResult.get(i).get(11), "");
				gdRes.getHeader("TOTAL_NEED"    ).addValue(qResult.get(i).get(12), "");
				gdRes.getHeader("AVL_MONTH"     ).addValue(qResult.get(i).get(13), "");
				gdRes.getHeader("BASE_STOCK"    ).addValue(qResult.get(i).get(14), "");				
				gdRes.getHeader("RECEIPT_EXPT"  ).addValue(qResult.get(i).get(15), "");			
				gdRes.getHeader("TOTAL_QTY"     ).addValue(qResult.get(i).get(16), "");
				gdRes.getHeader("PRO_MONTH"     ).addValue(qResult.get(i).get(17), "");
				gdRes.getHeader("NEED_QTY"     	).addValue(qResult.get(i).get(18), "");
				gdRes.getHeader("ORDER_QTY"     ).addValue(qResult.get(i).get(19), "");
