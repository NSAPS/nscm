...
public class ip_02090_hawastockSupportPlan_list_popup extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			gdRes = OperateGridData.cloneResponseGridData(gdReq);                                                            
				...
				String query_id   = "ip_02090_hawastockSupportPlan_list_popupcall"; 
...
//				gdRes.getHeader("CALOG_PLT_CAL"		) .addValue(qResult.get(i).get(5),""); 
				...
				gdRes.getHeader("DC_ID"				) .addValue(qResult.get(i).get(6),"");
				gdRes.getHeader("DC_NAME"			) .addValue(qResult.get(i).get(7),"");      
