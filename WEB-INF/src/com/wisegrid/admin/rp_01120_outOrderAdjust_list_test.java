 ...
 * @author iCOMPIA CORP.
 */
public class rp_01120_outOrderAdjust_list_test extends HttpServlet {
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {
			...
			for (int i = 0; i < rowCount; i++) {
				...
				//////////////////////////////////////////
				gdRes.getHeader("EXPORT_QTY1"	 ).addValue(qResult.get(i).get(26), "");//수출선적물량
				gdRes.getHeader("EXPORT_QTY2"	 ).addValue(qResult.get(i).get(27), "");//익일수출선적물량
				/////////////////////////////////////////
			}
