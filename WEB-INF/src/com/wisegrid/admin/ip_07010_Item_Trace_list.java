 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class ip_07010_Item_Trace_list extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_07010_Item_Trace_list";                                                             
	...
	public GridData doQuery2(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_07010_Item_Trace_list2";                                                             
	...
	public GridData doQuery3(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_07010_Item_Trace_list3";                                                             
