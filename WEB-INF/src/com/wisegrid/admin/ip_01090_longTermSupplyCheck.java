 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class ip_01090_longTermSupplyCheck extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String division		= gdReq.getParam("division");
			String cat03		= gdReq.getParam("cat03");
			                                                                                                                 
		
			String paramKey   ="item_id!%!item_name!%!week_flag!%!simul_data!%!sel_gubn!%!division!%!cat03";                                                                      
			String paramCode  = item_id+"!%!"+item_name+"!%!"+week_flag+"!%!"+simul_data+"!%!"+sel_gubn+"!%!"+division+"!%!"+cat03;
                                                                                                                             
			String query_id   = "ip_01090_longTermSupplyCheck_day";                                                             
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("HOLIDAY_FLAG" 	).addValue(qResult.get(i).get(2  ),"");                                     
				gdRes.getHeader("BASE_STOCK" 	).addValue(qResult.get(i).get(3  ),"");                                     
				gdRes.getHeader("IPGO" 			).addValue(qResult.get(i).get(4  ),"");                                     
				gdRes.getHeader("CHGO" 			).addValue(qResult.get(i).get(5  ),"");                                     
				gdRes.getHeader("MM" 			).addValue(qResult.get(i).get(6  ),"");
				gdRes.getHeader("WEEK_NO"		).addValue(qResult.get(i).get(7  ),"");
				gdRes.getHeader("LAST_MONTH"	).addValue(qResult.get(i).get(8  ),"");
				gdRes.getHeader("LAST_YEAR"		).addValue(qResult.get(i).get(9  ),"");
	...
	public GridData doQuery2(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_01090_longTermSupplyCheck_week";                                                             
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("IPGO" 			).addValue(qResult.get(i).get(4  ),"");                                     
				gdRes.getHeader("CHGO" 			).addValue(qResult.get(i).get(5  ),"");                                     
				gdRes.getHeader("CHGO_ORG"		).addValue(qResult.get(i).get(5  ),"");
				gdRes.getHeader("COUNT"			).addValue(qResult.get(i).get(6  ),"");
				gdRes.getHeader("MM" 			).addValue(qResult.get(i).get(7  ),"");
				gdRes.getHeader("WEEK_NO"		).addValue(qResult.get(i).get(8  ),"");
	...
	public GridData doQuery3(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_01090_longTermSupplyCheck_month";                                                             
	...
	public GridData doQuery4(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String paramKey   ="item_id!%!sel_gubn!%!division!%!cat03";                                                                      
			String paramCode  = item_id+"!%!"+sel_gubn+"!%!"+division+"!%!"+cat03;	                                                             
                                                                                                                             
			String query_id   = "ip_01090_longTermSupplyCheck_day_DW2";                                                             
	...
	public GridData doQuery5(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_01090_longTermSupplyCheck_day_DW3";                                                             
	...
	public GridData doQuery6(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String query_id   = "ip_01090_longTermSupplyCheck_day_DW4";                                                             
