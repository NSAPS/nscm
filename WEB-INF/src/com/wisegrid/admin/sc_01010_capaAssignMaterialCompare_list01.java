...
public class sc_01010_capaAssignMaterialCompare_list01 extends HttpServlet {
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {
			...
			String p_version1 = gdReq.getParam("version1"); //Capa 제약없음
			String p_version2 = gdReq.getParam("version2"); // Capa 제약
			String p_res_code = gdReq.getParam("res_code"); //설비유형.
			String p_item_list = gdReq.getParam("item_list"); //품목
			String p_factory = gdReq.getParam("factory"); //공장.
			...
			s_query += "\n    /* Capa 조건에 따른 할당물량 비교 : 설비유형, 공장별 */                                                                                              ";
			s_query += "\n    select ls.cat06, ls.cat06_name, ls.plant_id, ls.plant_name,                                                                                          ";
			...
			s_query += "\n      from (/* Capa 제약없음 */                                                                                                                          ";
			s_query += "\n            select im.cat06, cd.cat06_name, ct.dcpath2_cd plant_id, ct.dcpath2 plant_name                                                                ";
			...
			s_query += "\n           ) ls,                                                                                                                                         ";
			s_query += "\n           (/* Capa 제약없음 */                                                                                                                          ";
			s_query += "\n            select distinct im.cat06, cd.cat06_name, ct.dcpath2_cd plant_id, ct.dcpath2 plant_name,                                                      ";
			s_query += "\n                   sum(ct.qty) over(partition by im.cat06, ct.dcpath2_cd) nc_qty,                                                                        ";
			s_query += "\n                   round(sum(ct.qty) over(partition by im.cat06, ct.dcpath2_cd)/sum(ct.qty) over (partition by im.cat06), 2) nc_rate,                    ";
			s_query += "\n                   sum(ct.total_amt) over(partition by im.cat06, ct.dcpath2_cd) nc_amount                                                                ";
			s_query += "\n              from fa_cost_trace ct,                                                                                                                     ";
			s_query += "\n                   item_mst im,                                                                                                                          ";
			s_query += "\n                   (select cd cat06, cd_name cat06_name                                                                                                  ";
			s_query += "\n                      from code_mst                                                                                                                      ";
			...
			s_query += "\n           (/* Capa 제약 */                                                                                                                              ";
			s_query += "\n            select distinct im.cat06, cd.cat06_name, ct.dcpath2_cd plant_id, ct.dcpath2 plant_name,                                                      ";
			s_query += "\n                   sum(ct.qty) over(partition by im.cat06, ct.dcpath2_cd) ca_qty,                                                                        ";
			s_query += "\n                   round(sum(ct.qty) over(partition by im.cat06, ct.dcpath2_cd)/sum(ct.qty) over (partition by im.cat06), 2) ca_rate,                    ";
			s_query += "\n                   sum(ct.total_amt) over(partition by im.cat06, ct.dcpath2_cd) ca_amount                                                                ";
			s_query += "\n              from fa_cost_trace ct,                                                                                                                     ";
			s_query += "\n                   item_mst im,                                                                                                                          ";
			s_query += "\n                   (select cd cat06, cd_name cat06_name                                                                                                  ";
			s_query += "\n                      from code_mst                                                                                                                      ";
			...
			s_query += "\n     order by ls.cat06, ls.cat06_name, ls.plant_id, ls.plant_name                                                                                        ";
