 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class ip_01100_monthly_Stock_Prod_Sales_analysis_list extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			String search_flag  = gdReq.getParam("search_flag");
			String itype  		= gdReq.getParam("itype");
            
			String paramKey   = "in_fr_date!%!in_to_date!%!search_item!%!search_flag!%!itype";                                                                      
			String paramCode  = in_fr_date+"!%!"+in_to_date+"!%!"+search_item+"!%!"+search_flag+"!%!"+itype;                                                                   
			...
			String query_id   = "ip_01100_monthly_Stock_Prod_Sales_analysis_list";                                                             
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("SALE_DATE" ).addValue(qResult.get(i).get(2),""); 
				gdRes.getHeader("STOCK_QTY" ).addValue(qResult.get(i).get(3),"");                                     
				gdRes.getHeader("QTY1"	    ).addValue(qResult.get(i).get(4),"");
				gdRes.getHeader("QTY2"	    ).addValue(qResult.get(i).get(5),"");
	...
	public GridData doQuery2(GridData gdReq) throws Exception {                                                               
		...
		try {                                                                                                                
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("ITEM_NAME"	).addValue(qResult.get(i).get(1),"");
				gdRes.getHeader("SALE_DATE" ).addValue(qResult.get(i).get(2),""); 
				gdRes.getHeader("QTY1"	    ).addValue(qResult.get(i).get(3),"");
				gdRes.getHeader("QTY2"	    ).addValue(qResult.get(i).get(4),"");
