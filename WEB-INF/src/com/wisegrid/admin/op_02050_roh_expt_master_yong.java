 ...
 * @author iCOMPIA CORP.                                                                                                     
 */                                                                                                                          
public class op_02050_roh_expt_master_yong extends HttpServlet {                                                             
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {                                                                                                                
			...
			for (int i = 0; i < rowCount; i++) {                                                                             
				...
				gdRes.getHeader("ODER_QTY_W2" 		).addValue(qResult.get(i).get(11),"");
				gdRes.getHeader("W1_STOCK" 			).addValue(qResult.get(i).get(12),"");
				gdRes.getHeader("W2_STOCK" 			).addValue(qResult.get(i).get(13),"");
				gdRes.getHeader("SEL_DMD" 			).addSelectedHiddenValue(qResult.get(i).get(14));
				gdRes.getHeader("DMD_QTY" 			).addValue(qResult.get(i).get(15),"");
				gdRes.getHeader("DMD03" 			).addValue(qResult.get(i).get(16),"");
				gdRes.getHeader("DMD04" 			).addValue(qResult.get(i).get(17),"");
				gdRes.getHeader("DMD05" 			).addValue(qResult.get(i).get(18),"");
				gdRes.getHeader("DMD06" 			).addValue(qResult.get(i).get(19),"");
				gdRes.getHeader("DMD07" 			).addValue(qResult.get(i).get(20),"");				
				gdRes.getHeader("DMD08" 			).addValue(qResult.get(i).get(21),"");
				gdRes.getHeader("USE_DAY" 			).addValue(qResult.get(i).get(22),"");
				gdRes.getHeader("USE_QTY" 			).addValue(qResult.get(i).get(23),"");				
				gdRes.getHeader("MIN_LOT_SIZE" 		).addValue(qResult.get(i).get(24),"");
				gdRes.getHeader("FC_QTY" 			).addValue(qResult.get(i).get(25),"");  
				gdRes.getHeader("MSG"				).addValue(qResult.get(i).get(26),"");	
